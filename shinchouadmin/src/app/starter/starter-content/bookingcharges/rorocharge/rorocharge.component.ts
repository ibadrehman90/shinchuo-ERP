...
@Component({
  selector: 'app-rorocharge',
  templateUrl: './rorocharge.component.html',
  styleUrls: ['./rorocharge.component.css']
})
export class RorochargeComponent implements OnInit {
  ...
  addcharge()
  {
    ...
    {
      this.myService.addrorocharge(this.model.chargename, window.localStorage.getItem("adm_user")).subscribe((data)=>{          

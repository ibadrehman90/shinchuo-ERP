...
@Component({
  selector: 'app-addbookingservices',
  templateUrl: './addbookingservices.component.html',
  styleUrls: ['./addbookingservices.component.css']
})
export class AddbookingservicesComponent implements OnInit {
  ...
  getServices()
  {
    this.myService.getbookingservice().subscribe((data)=>{          
  ...
  getPendingServices()
  {
    this.myService.getpendingbookingservice().subscribe((data)=>{          
  ...
  addservice()
  {
    ...
    {
      this.myService.addbookingservice(this.model.servicename, window.localStorage.getItem("adm_user")).subscribe((data)=>{          

...
export class ViewtransportComponent implements OnInit {
  ...
  UpdateStatus(event, ind)
  {
    ...
    this.myService.updateStatusTransportCompany(ind, stat).subscribe((data)=>{          
  ...
  UpdateShippers(ind)
  {
    this.router.navigate(["edit_transportcompany/" + ind]);
  }
  ...
  { 
    ...
    this.myService.searchTransportCompany(this.model.sname, this.model.cperson, this.model.tel, this.model.mob, this.model.fax, this.model.email, statans).subscribe((data)=>{          

...
export class AddbuyerComponent implements OnInit {
  ...
  SaveForm()
  {
    ...
    if(this.model.bname != undefined && this.model.email != undefined && this.model.mob != undefined && this.model.pass != undefined && this.model.cpass != undefined && this.model.city != undefined && this.model.country != undefined && this.model.username != undefined)
    {
      ...
      {
        this.myService.addBSUser(this.model.username, this.model.pass, this.model.email, this.model.bname, this.model.city, this.model.country, this.model.mob, "1", "1", "buyer").subscribe((data)=>{          
